<?php
    ...
    switch ($method){ 
        ...
        case "PUT": // Update course
        if ($course->updateCourse($input['id'], $input['course_code'], $input['course_name'], $input['course_progression'], $input['course_link'])) {
            http_response_code(201); // Course was successfully updated
    ...
    case "DELETE": // Delete course
        if ($course->deleteCourse($input['id'])) {
            http_response_code(201); // Course was successfully deleted
